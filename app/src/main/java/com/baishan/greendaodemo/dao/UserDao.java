...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property AnimalId = new Property(3, long.class, "animalId", false, "ANIMAL_ID");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER\" (" + //
                ...
                "\"NAME\" TEXT," + // 1: name
                "\"PWD\" TEXT," + // 2: pwd
                "\"ANIMAL_ID\" INTEGER NOT NULL );"); // 3: animalId
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, User entity) {
        ...
        stmt.bindLong(4, entity.getAnimalId());
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.getLong(offset + 3) // animalId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setAnimalId(cursor.getLong(offset + 3));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getAnimalDao().getAllColumns());
            builder.append(" FROM USER T");
            builder.append(" LEFT JOIN ANIMAL T0 ON T.\"ANIMAL_ID\"=T0.\"_id\"");
            builder.append(' ');
    ...
    protected User loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        Animal animal = loadCurrentOther(daoSession.getAnimalDao(), cursor, offset);
         if(animal != null) {
